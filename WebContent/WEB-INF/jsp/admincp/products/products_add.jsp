	...
	<div class="panel panel-default">
		...
		<div style="text-align: center;" class="panel-heading">
			<span
				...
				mới hoa</span>
			<!-- Form -->
			<form class="form-horizontal form_product" action="${pageContext.request.contextPath}/admincp/hoa/them" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<select class="form-control" name="id_species" id="kieu">
							<option value="0" >---Chọn kiểu hoa---</option>
							<c:forEach items="${lSpecies}" var="species">
								<option value="${species.id_species}">${species.name}</option>
							</c:forEach> 
						</select>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<textarea name="preview" class="form-control" rows="5" placeholder="Nhập mô tả" id="mota"></textarea>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="number" class="form-control" id="giaban" name="price" value="0"
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="number" class="form-control" id="soluong" name="number" value="0"
				...
				<div class="form-group">
					<label for="detail" class="col-sm-2 control-label">Chi tiết:</label>
					<div class="col-sm-8">
						<textarea class="ckeditor form-control" name="detail" rows="5" id="detail"></textarea>

				...
				<div class="mail-toolbar clearfix" style="text-align: left;">
					<div class="float-left">
						<a href="javascript:void(0)" id="chkAll"
							...
							href="${pageContext.request.contextPath}/admincp/kieu-hoa/them"
							...
							<div class="btn-group m-r-sm mail-hidden-options"
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-menu-left" role="menu">
										<li><a
											href="${pageContext.request.contextPath}/admincp/kieu-hoa?h=5">5
												sản phẩm</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/kieu-hoa?h=10">10
												sản phẩm</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/kieu-hoa?h=20">20
												sản phẩm</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/kieu-hoa?h=50">50
												sản phẩm</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/kieu-hoa?h=100">100
												sản phẩm</a></li>
									</ul>
								</div>
							</div>
				...
				<table class="table tab-border" style="text-align: left;"
					...
					<tbody>
						...
						<c:forEach items="${lItem}" var="Item">
							<c:set value="${Item.id_species}" var="id"></c:set>
							<c:set var="urlEdit"
								value="${pageContext.request.contextPath}/admincp/kieu-hoa/sua/${id }"></c:set>
							<c:set var="urlDel"
								value="${pageContext.request.contextPath}/admincp/kieu-hoa/xoa/${id }"></c:set>
							<tr>
								...
								<td><a href="${urlEdit}" class="hvr-shadow-radial"
									style="padding: 4px; margin: 0px">Sửa</a> <a onclick="return confirm('Xóa kiểu hoa đồng thời xóa các hoa thuộc kiểu này. Bạn chắc chắn muốn xóa?');" href="${urlDel}"
	...
	<script type="text/javascript">
		...
		function valDels()
		{
		    ...
		    if (checkedAtLeastOne == true){
				return confirm('Xóa kiểu hoa đồng thời xóa các hoa thuộc kiểu này. Bạn chắc chắn muốn xóa?');
		    } else {

...
<div class="inner-block">
	<div class="panel panel-default">
		...
		<div style="text-align: center;" class="panel-heading">
			<span
				style="font-size: 30px; font-weight: bold; font-family: serif; color: #68ae00;">Sửa kiểu hoa</span>
			<!-- Form -->
			<form class="form-horizontal form_species" action="${pageContext.request.contextPath}/admincp/kieu-hoa/sua/${Item.id_species}" method="post">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="name" value="${Item.name}" name="name"
							...
							hidden="hidden" type="text" value="${Item.id_species}" id="check_id">

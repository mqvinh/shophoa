	...
	<div class="panel panel-default">
		...
		<div style="text-align: center;" class="panel-heading">
			<span
				...
				lý phương thức thanh toán</span>
		</div>
		<!-- Table -->
			...
			<div class="mailbox-border" style="text-align: center;">
				<div class="mail-toolbar clearfix" style="text-align: left;">
					<div class="float-left">
						...
						<a
							href="${pageContext.request.contextPath}/admincp/thanh-toan/them"
							...
							<div class="btn-group m-r-sm mail-hidden-options"
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-menu-left" role="menu">
										<li><a
											href="${pageContext.request.contextPath}/admincp/thanh-toan?h=5">5
												tin</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/thanh-toan?h=10">10
												tin</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/thanh-toan?h=20">20
												tin</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/thanh-toan?h=50">50
												tin</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/thanh-toan?h=100">100
												tin</a></li>
									</ul>
								</div>
							</div>
				...
				<table class="table tab-border" style="text-align: left;"
					...
					<tbody>
						...
						<c:forEach items="${lItem}" var="Item">
							...
							<c:set var="urlEdit"
								value="${pageContext.request.contextPath}/admincp/thanh-toan/sua/${id }"></c:set>
							<c:set var="urlDel"
								value="${pageContext.request.contextPath}/admincp/thanh-toan/xoa/${id }"></c:set>
							<tr>

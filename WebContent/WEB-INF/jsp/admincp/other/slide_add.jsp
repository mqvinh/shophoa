...
<div class="inner-block">
	<div class="panel panel-default">
		...
		<div style="text-align: center;" class="panel-heading">
			<span
				style="font-size: 30px; font-weight: bold; font-family: serif; color: #68ae00;">Thêm slide</span>
			<!-- Form -->
			<form class="form-horizontal" action="${pageContext.request.contextPath}/admincp/slide/them" method="post" enctype="multipart/form-data">

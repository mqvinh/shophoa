		...
		<div class="col-md-4 compose">
			<div class="mail-profile">
				...
				<div class="mailer-name">
					...
					<h6>
						<a href="mailto:info@example.com">malorum@gmail.com</a>
					</h6>
				</div>
			...
			<div class="inbox-details-default">
				...
				<div class="inbox-details-body">
					<div class="alert alert-info">Please fill details to send a
						new message</div>
					<form class="com-mail">
						<input type="text" value="To :" onfocus="this.value = '';"
							onblur="if (this.value == '') {this.value = 'To';}"> <input
							type="text" value="Subject :" onfocus="this.value = '';"
							onblur="if (this.value == '') {this.value = 'Subject';}">

						<textarea rows="6" value="Message :" onfocus="this.value = '';"

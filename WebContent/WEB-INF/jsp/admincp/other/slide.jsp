			...
			<div class="mailbox-border" style="text-align: center;">
				<div class="mail-toolbar clearfix" style="text-align: left;">
					<div class="float-left">
						...
						<a href="${pageContext.request.contextPath}/admincp/slide/them"
							...
							<div class="btn-group m-r-sm mail-hidden-options"
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-menu-left" role="menu">
										<li><a
											href="${pageContext.request.contextPath}/admincp/slide?h=5">5
												user</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/slide?h=10">10
												user</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/slide?h=20">20
												user</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/slide?h=50">50
												user</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/slide?h=100">100
												user</a></li>
									</ul>
								</div>
							</div>
				...
				<table class="table tab-border" style="text-align: left;"
					...
					<tbody>
						...
						<c:forEach items="${lItem}" var="Item">
							...
							<c:set var="urlEdit"
								value="${pageContext.request.contextPath}/admincp/slide/sua/${id }"></c:set>
							<c:set var="urlDel"
								value="${pageContext.request.contextPath}/admincp/slide/xoa/${id }"></c:set>
							<tr>

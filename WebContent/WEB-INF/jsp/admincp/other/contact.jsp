							...
							<div class="btn-group m-r-sm mail-hidden-options"
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-menu-left" role="menu">
										<li><a
											href="${pageContext.request.contextPath}/admincp/lien-he?h=5">5
												row</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/lien-he?h=10">10
												row</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/lien-he?h=20">20
												row</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/lien-he?h=50">50
												row</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/lien-he?h=100">100
												row</a></li>
									</ul>
								</div>
							</div>
				...
				<table class="table tab-border" style="text-align: left;"
					...
					<tbody>
						...
						<c:forEach items="${lItem}" var="Item">
							...
							<c:set var="urlEdit"
								value="${pageContext.request.contextPath}/admincp/lien-he/chi-tiet/${id }"></c:set>
							<c:set var="urlDel"
								value="${pageContext.request.contextPath}/admincp/lien-he/xoa/${id }"></c:set>
							<tr>
								...
								<td><a href="${urlEdit}" class="hvr-shadow-radial"
									style="padding: 4px; margin: 0px">Xem</a> <a href="${urlDel}"

...
<div class="inner-block">
	<div class="panel panel-default">
		...
		<div style="text-align: center;" class="panel-heading">
			<span
				style="font-size: 30px; font-weight: bold; font-family: serif; color: #68ae00;">Thêm giới thiệu</span>
			<!-- Form -->
			<form class="form-horizontal" action="${pageContext.request.contextPath}/admincp/gioi-thieu/them" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<textarea id="chitiet" name="detail" class="ckeditor form-control" rows="5"></textarea>

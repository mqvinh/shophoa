...
<div class="inner-block">
	<div class="panel panel-default">
		...
		<div style="text-align: center;" class="panel-heading">
			...
			<!-- Form -->
			<form class="form-horizontal" action="${pageContext.request.contextPath}/admincp/slide/sua/${Item.id}" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<label for="link" class="col-sm-2 control-label">Link:</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" id="link" name="link" value="${Item.link}"
							placeholder="Nhập link">
							<form:errors path="objItem.link" cssStyle="color: red"></form:errors>
					</div>
				</div>
				<div class="form-group">
					<label for="status" class="col-sm-2 control-label">Mô tả:</label>
					<div class="col-sm-8">
						<textarea id="mota" name="preview" class="form-control" rows="5" placeholder="Nhập mô tả">${Item.preview}</textarea>

			...
			<div class="mailbox-border" style="text-align: center;">
				<div class="mail-toolbar clearfix" style="text-align: left;">
					<div class="float-left">
						...
						<a
							href="${pageContext.request.contextPath}/admincp/nguoi-dung/cap-bac/them"
							...
							<div class="btn-group m-r-sm mail-hidden-options"
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-menu-left" role="menu">
										<li><a
											href="${pageContext.request.contextPath}/admincp/nguoi-dung/cap-bac?h=5">5
												row</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/nguoi-dung/cap-bac?h=10">10
												row</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/nguoi-dung/cap-bac?h=20">20
												row</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/nguoi-dung/cap-bac?h=50">50
												row</a></li>
										<li><a
											href="${pageContext.request.contextPath}/admincp/nguoi-dung/cap-bac?h=100">100
												row</a></li>
									</ul>
								</div>
							</div>
				...
				<table class="table tab-border" style="text-align: left;"
					...
					<tbody>
						...
						<c:forEach items="${lItem}" var="Item">
							<c:set value="${Item.role}" var="id"></c:set>
							<c:set var="urlEdit"
								value="${pageContext.request.contextPath}/admincp/nguoi-dung/cap-bac/sua/${id }"></c:set>
							<c:set var="urlDel"
								value="${pageContext.request.contextPath}/admincp/nguoi-dung/cap-bac/xoa/${id }"></c:set>
							<tr>
	...
	<script type="text/javascript">
		...
		function valDels() {
			...
			if (checkedAtLeastOne == true) {
				return confirm('Xóa cấp bậc đồng thời xóa user có cấp bậc nay. Bạn cóc chắc chắn muốn xóa?');
			} else {
